...
Component({
  ...
  methods: {
    ...
    onShareAppMessage: function () {
      if (this.data.user) {
        return {
          title: this.data.user.nickName + '推荐《' + this.data.detail.title.rendered + '》给你，点击查看',
          path: '/pages/index/index?gotourl=/pages/detail/detail&id=' + this.data.detail.id + '&isshare=1&posttype=' + this.data.posttype + '&cnttype=' + this.data.cnttype
        }
      } else {
        return {
    ...
    onShareTimeline: function () {
      return {
        title: this.data.detail.title.rendered + ' - ' + this.data.siteinfo.name,
        query: 'id=' + this.data.detail.id + '&isshare=1&posttype=' + this.data.posttype +'&cnttype=' + this.data.cnttype,
