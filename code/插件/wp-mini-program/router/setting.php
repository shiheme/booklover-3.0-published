...
class WP_REST_Setting_Router extends WP_REST_Controller {
	...
	public function get_wp_setting_info(  ) {
		$data = array( 
			...
			// 小鱼哥 增加 字段
			'authimg' => wp_miniprogram_option('authimg'),
			'safemode' => wp_miniprogram_option('safemode'),
			'zcmmode' => wp_miniprogram_option('zcmmode'),
			'zcmimg' => wp_miniprogram_option('zcmimg'),
			'mineimg' => wp_miniprogram_option('mineimg'),
		);
