	...
	public function wp_user_login_by_code( $request ) {
		...
		$user = array(
			"user"	=> array(
				...
				// 小鱼哥 增加 字段
				'user_registered' 			=> get_date_from_gmt($user->user_registered),
				'user_likes'	=> apply_filters('comment_type_user_count','', $user_id, 'like'),
				'user_fav'		=> apply_filters('comment_type_user_count','library', $user_id, 'fav'),
				'user_comment'	=> apply_filters('comment_type_user_count','library', $user_id, 'comment'),
