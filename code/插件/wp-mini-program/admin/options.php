	...
	$options = array(
		...
		'general-setting'=>[
			...
			'fields'=> [
				...
				//  小鱼哥 增加新的字段
				'authimg'		=>['title'=>'作者微信号','type'=>'upload','class'=>'regular-text'],
				'newrestapi'	=>['title'=>'RestAPI路径','type'=>'text','rows'=>4,'placeholder'=>'wp-json','description'=>'防止RestAPI内容外露，请重新命名并更新保存【固定连接】设置'],
				'safemode'		=>['title'=>'安全模式','type'=>'checkbox','description'=>'启用后会隐藏文中的视频、下载、评论等模块，建议小程序提交审核时开启'],
				'zcmmode'		=>['title'=>'开启招财猫','type'=>'checkbox','description'=>'启用后详情页会出现晃动的招财猫图片，配合打赏图片使用'],
				'zcmimg'		=>['title'=>'打赏图片','type'=>'upload','class'=>'regular-text'],
				'mineimg'		=>['title'=>'个人中心背景海报','type'=>'upload','class'=>'regular-text','description'=>'更新后记得清除缓存'],
